...
- `USE_SERVICE_ACCOUNTS`: Whether to use Service Accounts or not. For this to work see [Using Service Accounts](#using-service-accounts-for-uploading-to-avoid-user-rate-limit) section below.
